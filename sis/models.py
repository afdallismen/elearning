...
class Assignment(models.Model):
    ...
    def __repr__(self):
        if self.short_description:
            return "Assignment(\"{desc}\")".format(desc=self.short_description)
...
class Question(models.Model):
    ...
    def __repr__(self):
        return ("Question(assignment={assignment})"
                .format(assignment=repr(self.assignment)))
...
class Answer(models.Model):
    ...
    def __repr__(self):
        return ("Answer(question={question}, assignment={assignment})"
                .format(question=self.question, assignment=self.assignment))
...
class AssignmentResult(models.Model):
    ...
    def __repr__(self):
        return ("AssignmentResult(student={student}, assignment={assignment},"
                "score={score}").format(
                    student=repr(self.student),
                    assignment=repr(self.assignment),
                    score=self.score)
...
class FinalResult(models.Model):
    ...
    def __repr__(self):
        return ("FinalResult(student={student}, score={score})"
                .format(student=repr(self.student), score=self.score))
